...
namespace CandidatosSistema.Controllers
{
    public class AdminUsuariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UsuarioId,Nombre,Usuario1,Clave,FechaAlta,Estado,Puesto")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UsuarioId,Nombre,Usuario1,Clave,FechaAlta,Estado,Puesto")] Usuario usuario)
        {
            if (ModelState.IsValid)
            {
